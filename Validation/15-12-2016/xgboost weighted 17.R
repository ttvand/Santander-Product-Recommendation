################################################
# XGBOOST weighted 17 - Validation on May 2016 #
################################################
...
loadFile <- "xgboost weighted trainAll 17, validation May16"
submissionFile <- "xgboost weighted trainAll 17, validation May16"
...
validationFeaturesFolder <- "validation"

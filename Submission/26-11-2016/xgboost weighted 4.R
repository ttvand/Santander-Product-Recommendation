##################################
# XGBOOST weighted predictions 4 #
##################################
...
loadFile <- "xgboost weighted posFlanks 4 linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation marginal, exponential normalisation joint"
submissionFile <- "xgboost weighted posFlanks 4 marginal exp mult 2, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation marginal, linear normalisation conditional"

# Target date 
targetDate <- "12-11-2016"

# Marginal exponential multiplier
marginalExpMult <- 2
...
# trainModelsFolder <- "trainTrainAllBack13-0TrainAll"
...
# Load the test data with lag seventeen

##################################
# XGBOOST weighted predictions 6 #
##################################
...
submissionDate <- "28-11-2016"
loadFile <- "xgboost weighted posFlanks 5, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted posFlanks 5, double weight dec15 vs jun15 other 0 cco_fin linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"
...
# baseModelInfo[, sum(relativeWeight), targetProduct]

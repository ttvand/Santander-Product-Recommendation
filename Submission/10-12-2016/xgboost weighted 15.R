...
loadFile <- "xgboost weighted trainAll 15 onlyBoot, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted trainAll 15 onlyBoot, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

...
loadFile <- "xgboost weighted trainAll 13, linear increase jun15 times6 back 15-0 no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted trainAll 13, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

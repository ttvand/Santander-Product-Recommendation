...
submissionDate <- "08-12-2016"
loadFile <- "xgboost weighted stacked 3, linear increase jun15 times6 back 11-0 no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted stacked 3, linear increase jun15 times6 back 11-0 no zeroing, exponential normalisation joint"

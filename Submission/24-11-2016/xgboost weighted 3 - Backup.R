##################################
# XGBOOST weighted predictions 3 #
##################################
...
loadFile <- "xgboost weighted 2 linear increase jun15 times6 back 11-0 no zeroing, linear normalisation joint, exponential normalisation marginal"
submissionFile <- "xgboost weighted 3 linear increase jun15 times6 back 11-0 no zeroing, linear normalisation joint, exponential normalisation marginal"

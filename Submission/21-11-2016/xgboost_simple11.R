...
submissionDate <- "21-11-2016"
submissionFile <- "xgboost 11 back 11-0 Zero deco_fin deme_fin dela_fin fond_fin normalised linearly ccoNoPurchase"
...
leaderboardPosFlanks <- fractionPosFlank*nrow(testData)

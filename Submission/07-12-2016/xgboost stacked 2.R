...
submissionDate <- "07-12-2016"
loadFile <- "xgboost weighted stacked 2, linear increase jun15 times6 back 11-0 10 months no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted stacked 2, linear increase jun15 times6 back 11-0 months no zeroing, exponential normalisation joint"

...
submissionDate <- "16-12-2016"
loadFile <- "xgboost weighted trainAll 18 10 folds 200 rounds, median Probs, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"
submissionFile <- "xgboost weighted trainAll 18 10 folds 200 rounds, median Probs, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

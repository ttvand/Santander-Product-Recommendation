...
loadFile <- ""
submissionFile <- "xgboost weighted stacked trainAll 4, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

# Target date 
targetDate <- "12-11-2016"

# Target train model folders
trainModelsFolder <- "train Top 100 monthProduct 200 roundsTrainAll"
trainAll <- grepl("TrainAll", trainModelsFolder)

# Target feature files folder
# testFeaturesFolder <- "test"
testFeaturesFolder <- "testNoStagnantRemoval Top 100 monthProduct 200 rounds"
...
trainFn <- "train Top 100 monthProduct 200 rounds/Back15Lag1.rds"

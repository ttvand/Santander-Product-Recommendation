...
submissionFile <- "xgboost weighted trainAll 16 10 folds 200 rounds, lin mult reca 1, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

...
submissionFile <- "xgboost weighted trainAll 22, 10 folds, 20 folds Top"

# Target date 
targetDate <- "12-11-2016"

# Target train model folders
trainModelsFolder <- "trainTrainAll Top 100 monthProduct 200 rounds 10 Folds, 20 Folds Top"

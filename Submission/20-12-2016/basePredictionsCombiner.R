...
# baseModelsDate <- "20-12-2016"
# submissionDate <- "20-12-2016"
# loadPredsFile <- "xgboost weighted trainAll 22, 10 folds, 20 folds Top.rds"
...
submissionFile <- "xgboost weighted trainAll 16, cco rescaler 1.2 MAP boosting, 10 folds"
...
# confidenceRescalers[5] <- 0.9
# confidenceRescalers[18] <- 1.1
# confidenceRescalers[5] <- 1.1
# confidenceRescalers[18] <- 0.8
# confidenceRescalers[22:23] <- 0.9
...
# Source the exponential normalisation and MAP calculation logic
...
targetVars <- targetVars[!grepl("Rank", targetVars)]

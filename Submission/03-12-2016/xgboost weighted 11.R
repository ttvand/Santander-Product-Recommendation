###################################
# XGBOOST weighted predictions 11 #
###################################
...
loadFile <- ""
submissionFile <- "xgboost weighted trainAll 11 top 100 product, linear increase jun15 times6 back 13-0 no zeroing, exponential normalisation joint"

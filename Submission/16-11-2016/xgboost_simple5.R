...
submissionDate <- "16-11-2016"
submissionFile <- "xgboost simple 5 back 11-0 monthlyMAPContributions.csv"

# Target date 
targetDate <- "12-11-2016"

# Target train models
# targetTrainModels <- "trainBack11-1SmallOrdered"
...
# Study the ranking of a specific product
productRank <- allPredictions[product=="ind_dela_fin_ult1", .N, order_predict]

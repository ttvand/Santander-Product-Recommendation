...
jun16Counts <- c(0, 0, 10047, 4, 1855, 59, 466, 232, 145, 0, 0, 98, 
...
featureSample <- readRDS(file.path(getwd(), "Second level learners",
                                   "Features", targetDate,
                                   "trainFixedLag5",
                                   "Back0Lag16.rds"))
...
modelGroupsFolder <- file.path(getwd(), "Second level learners",
                               "Models", targetDate, modelGroup)
...
saveRDS(overallProductFeatureRanks,
        file.path(getwd(), "second level learners", targetDate,
